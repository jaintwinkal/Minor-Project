...
message = tk.Label(window, text="Face Recognition based Attendance Management System" ,bg="cyan"  ,fg="green"  ,width=50  ,height=3 ,font=('times', 30, 'italic bold')) 
...
lbl3 = tk.Label(window, text="Attendance : ",width=20  ,fg="white"  ,bg="red"  ,height=2 ,font=('times', 15, ' bold  underline')) 
